...
import LugarMdatos from '../lugares/LugarMdatos';
...
const Registro = ({ registro, setActualizar, pruebas }) => {
  ...
  // ----- Por defecto, los lugares son en españa. SI HAY LUGARES FUERA DE ESPAÑA, CAMBIAR EL LOCALE SEGÚN EL LUGAR -------
  let locale = "ES-es";
  ...
  // const momentoFormateado = new Date(momento).toLocaleString(locale, {
  //   year: "numeric",
  //   month: "numeric",
  //   day: "numeric",
  //   hour: "numeric",
  ...
  const date = new Date(registro.momento + "Z");
  const momentoFormateado = formateador.format(date);

  console.log("momento: " + registro.momento);
  console.log("momentoF: " + momentoFormateado);
    ...
    <div className="bg-slate-50 p-2 flex flex-col">
      ...
      <address>
        ...
        <div className="flex flex-wrap">
          ...
          {adjuntosData.map(({ adjunto, url_persigned_archivo, cargando }) => {
      ...
      <div>
        <LugarMdatos lugar_mdatos={registro}></LugarMdatos>
      </div>
...

      {
        ...
        (<div className='flex mt-2 gap-2'>
          ...
          >
            <NavLink to={`/registro/${registro.registro_id}/modificar/pruebas`} className="hover:font-bold">
              <b>Modificar</b>
            </NavLink>          </div>
